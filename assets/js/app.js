...
// 6. Generic AJAX Form Submit Handler helper
function handleFormSubmit(formId, successMessage, callback = null) {
    ...
    form.addEventListener('submit', (e) => {
        ...
        fetch('api.php', {
            ...
            .then(response => {
                if (!response.ok) {
                    throw new Error('Network error or server returned status ' + response.status);
                }
            ...
            .then(res => {
                if (res.status === 'success') {
                    ...
                    if (callback) {
                        ...
                        // Default behavior: reload page after short delay to show fresh data
                        setTimeout(() => {
