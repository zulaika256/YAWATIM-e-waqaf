...
if ($role === 'admin') {
    $allowed_pages = ['dashboard', 'wakalah_individual', 'wakalah_corporate', 'donations', 'performance', 'reports', 'settings'];
} elseif ($role === 'wakalah_corporate') {
    $allowed_pages = ['dashboard', 'donations', 'my_booth', 'performance', 'settings'];
} else {
    // wakalah_individual — no booth access
    $allowed_pages = ['dashboard', 'donations', 'performance', 'settings'];
}
