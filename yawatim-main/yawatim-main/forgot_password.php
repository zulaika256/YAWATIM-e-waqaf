...
$step        = 1;          // 1 = email form, 2 = new password form, 3 = success
$error_msg   = '';
$success_msg = '';
...
<body class="login-body" style="--login-accent: #1d4ed8; --login-accent-light: #eff6ff; --login-accent-dark: #1e40af;">
        ...
        <?php elseif ($step === 2): ?>
            ...
            <form action="forgot_password.php" method="POST" id="form-reset">
                ...
                <div class="form-group">
                    ...
                    <div class="strength-label" id="strength-label">Type to check strength</div>
                </div>
                <div class="form-group" style="margin-bottom: 1.25rem;">
            ...
            <div style="text-align: center; margin-top: 0.75rem;">
                <a href="forgot_password.php" style="font-size: 0.82rem; color: var(--light-neutral); text-decoration: none;">
    ...
    function checkStrength(val) {
        ...
        const map = [
            { pct: '0%',   color: '#e2e8f0', text: 'Type to check strength' },
        ...
        const m = map[Math.min(strength, 5)];
        bar.style.width     = val.length === 0 ? '0%' : m.pct;
        bar.style.background = m.color;
        label.textContent   = val.length === 0 ? 'Type to check strength' : m.text;
